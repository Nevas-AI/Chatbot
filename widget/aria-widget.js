  ...
  function showBookingForm() {
    ...
    bookingCard.innerHTML = `
      <div style="padding: 22px 20px; text-align: center;">
        ...
        <p style="margin: 0 0 18px; font-size: 13px; color: var(--aria-text-secondary); line-height: 1.5;">Choose a convenient date & time that works best for you</p>
        ...
        <p style="margin: 12px 0 0; font-size: 11.5px; color: var(--aria-text-secondary); font-weight: 500; display: flex; align-items: center; justify-content: center; gap: 6px;">
    ...
    if (bookBtn) {
      ...
      bookBtn.addEventListener("click", function () {
        ...
        // Open booking page in a centered popup window for best experience
        var w = 700, h = 750;
