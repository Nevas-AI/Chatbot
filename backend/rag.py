    ...
    def __init__(self, config: Optional[Dict] = None):
        ...
        if self.booking_url:
            booking_instructions = (
                ...
                "IMPORTANT: Because booking is enabled, you must NEVER use [SHOW_LEAD_FORM]. "
                "Always use [SHOW_BOOKING_FORM] instead for ALL buying signals, including:\n"
                "- Questions about pricing, cost, or licensing\n"
                "- Requests for demos, trials, or consultations\n"
                "- Interest in implementing or switching ERP systems\n"
                "- \"How do I get started?\" or \"Can your team help?\"\n"
                "- Questions about timelines or project scope\n"
                "- Any appointment-related request (book a demo, schedule a meeting, set up a call, etc.)\n\n"
                "When you detect any of these buying signals, respond with a brief, warm message "
                "and append the special system marker [SHOW_BOOKING_FORM] at the end of your message.\n"
                "Example:\n"
                "\"I'd love to help you get started! You can schedule a time with our team right here:\n"
                "[SHOW_BOOKING_FORM]\"\n"
                "Do NOT use [SHOW_LEAD_FORM] — it is disabled for this client.\n"
